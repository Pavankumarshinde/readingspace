...
export default async function ManagerProfile() {
  ...
  const parts = profile.business_name
    ? profile.business_name.trim().split(" ")
  ...
  return (
    <div className="page-shell">
      ...
      <div className="scroll-area px-4 md:px-8 pb-32 md:pb-8">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row md:items-stretch gap-8 md:gap-12 pb-4 animate-in fade-in duration-700">
          {/* Avatar + Name */}

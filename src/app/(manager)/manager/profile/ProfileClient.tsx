...
export function HowToUseManagerButton() {
  ...
  const steps = [
    { title: 'Setup Facility', desc: "Keep your business name and address updated in the Profile tab." },
    { title: 'Manage Rooms', desc: "Create rooms and configure their tiers, capacity, and auto-generated join keys." },
    { title: 'Review Students', desc: "Accept or reject join requests from the Directory tab." },
    { title: 'Monitor Attendance', desc: "Track room check-ins daily inside the detailed room views." },
    { title: 'Need Help?', desc: "Use the 'Send Query' button below to contact system support." }
  ]

...
export default function LoginPage() {
  ...
  return (
    <div className="page-shell items-center justify-center px-5 py-8 bg-surface relative font-body">
          ...
          {mode === "forgot_password" && (
            ...
            >
              <div className="text-center mb-4">
                <h2 className="font-headline text-on-surface text-base font-medium">
                  Forgot Password?
                </h2>
              ...
              <div className="space-y-2 pt-1">
                <button
                  ...
                  type="submit"
                  disabled={loading}
                  className="w-full bg-on-surface text-surface py-3.5 rounded-2xl text-[12px] font-bold uppercase tracking-widest hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                >
                ...
                <button
                  ...
                  className="w-full py-3 bg-surface-container-lowest text-on-surface-variant rounded-2xl border border-outline-variant/20 text-[11px] font-bold uppercase tracking-widest hover:bg-surface-container-low transition-all flex items-center justify-center gap-1.5"
                >
          ...
          {mode === "verify_otp" && (
            ...
            >
              ...
              <button
                ...
                className="w-full bg-primary text-white py-3.5 rounded-2xl text-[12px] font-bold uppercase tracking-widest shadow-md hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center justify-center gap-2 disabled:opacity-70"
              >
          ...
          {mode === "reset_password" && (
            ...
            >
              ...
              <button
                ...
                type="submit"
                disabled={loading}
                className="w-full bg-on-surface text-surface py-3.5 rounded-2xl text-[12px] font-bold uppercase tracking-widest shadow-md hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center justify-center gap-2 disabled:opacity-70"
              >

  ...
  return (
    <div className="page-shell">
      ...
      <div className="sticky-page-header pt-[calc(env(safe-area-inset-top,0px)+3.5rem)] md:pt-0 shrink-0">
        ...
        <div
          className="flex gap-1.5 overflow-x-auto pb-4 pt-0 px-4 md:px-8 max-w-[1400px] mx-auto scrollbar-none"
      ...
      <div className="scroll-area px-4 md:px-8 pb-32 md:pb-8 max-w-[1400px] mx-auto w-full">

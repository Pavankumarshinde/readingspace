        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-3 pt-2">
          ...
          <div className="flex bg-white p-1.5 rounded-2xl border border-slate-200 shadow-sm h-11 shrink-0">
            ...
            <div className="px-4 py-1 text-center flex flex-col justify-center">
              ...
              <p className="text-base font-extrabold text-secondary leading-none">
                {stats.notes}
              </p>
            </div>
          </div>
          ...
          <section>
            {activeSub ? (
              ...
              <div className="card p-8 bg-white border-2 border-dashed border-slate-200 text-center flex flex-col items-center">
                ...
                <p className="text-xs font-medium text-slate-500 mt-1.5 mb-8 max-w-sm">
                  Join a reading room to track your daily sessions, notes, and
                  study progress.
                </p>
            ...
            <section className="lg:col-span-8 space-y-4">
              <div className="flex items-center justify-between px-1">
                <div className="flex items-center gap-2.5">
                  ...
                  <h4 className="font-headline text-on-surface tracking-tight text-base font-medium">
                    Recent Notes
                  </h4>
                </div>
                <Link
                  href="/student/my-space"
                  className="text-[10px] font-bold text-primary uppercase tracking-widest hover:text-indigo-700 transition-colors"
                >
                  See All
                </Link>
              </div>
                  ...
                  recentNotes.map((note) => (
                    <Link key={note.id} href="/student/my-space">
                      <article className="card p-5 bg-white border border-slate-100 group hover:border-primary/40 hover:shadow-2xl hover:shadow-primary/10 transition-all cursor-pointer h-full flex flex-col">
                        <time className="text-[9px] font-bold text-slate-400 uppercase tracking-wider block mb-2">
                          {format(new Date(note.created_at), "dd MMM, yyyy")}
                        </time>
                        <h5 className="text-base text-on-surface group-hover:text-primary transition-colors mb-2 line-clamp-1 font-medium">
                          {note.title}
                        </h5>
              ...
              <div className="card p-5 bg-white border border-slate-100 h-full flex flex-col">
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 transition-colors hover:bg-white hover:border-secondary/10 group">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-[11px] font-extrabold text-secondary tracking-tight">
                        Going Great
                      </p>

    ...
    <Modal open={open} onClose={onClose} title="Join a Reading Room">
      <form onSubmit={handleJoin} className="flex flex-col gap-6">
        <p className="text-[14px] text-[var(--text-secondary)] -mt-2">
          Enter the 8-character unique key provided by your room manager to
          request access.
        </p>
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="btn-primary py-4 rounded-xl font-bold"
          >
          ...
          <button
            type="button"
            onClick={onClose}
            className="btn-ghost py-3 text-[var(--text-muted)] font-semibold"
          >
            Cancel
          </button>
        </div>
